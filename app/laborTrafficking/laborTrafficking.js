...
var solrQueryUrl = 'http://141.161.20.98:8080/solr/labortrafficking/winwin';

var phpUploadInteractionUrl='index.php?r=index/postEvent';
var phpGetFullPageUrl='index.php?r=laborTrafficking/downloadFullPage';
...
dumplingApp.controller('dynamicController', function($scope, $rootScope, $sce, solrService) {
	...
	*/
	...
	$scope.$on('sendQuery',function(event, args){
		$rootScope.readDocEvents=[];
		solrService.queryData(args.query).then(function (data){
			var transition;
