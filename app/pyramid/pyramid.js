...
var solrQueryUrl = 'http://141.161.20.98:8080/solr/pyramid/winwin';
var solrSelectQueryUrl = 'http://141.161.20.98:8080/solr/pyramid/select';
...
dumplingApp.controller('dynamicController', function(topicService, rootCookie,$scope, $rootScope, $sce, solrService) {
	...
	$scope.clickContent=function(doc){
		...
		//var popupWindow = window.open('app/pyramid/popupWindow.html');
